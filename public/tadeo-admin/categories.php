...
<head>
    <meta charset="utf-8">
    <title>Kategoritë | Tadeo Bar Admin</title>
...
<body>
    <div class="admin-layout">
        ...
        <main>
            ...
            <p class="admin-muted">
                Menaxho kategoritë e menusë, emrat, ikonat, renditjen dhe statusin.
            </p>
                    ...
                    <article class="product-admin-card">
                        <div class="product-admin-top">
                            <div class="product-number">
                                <?= e($category['icon']) ?> #<?= e($category['sort_order']) ?>
                            </div>
                        ...
                        <div class="admin-muted">Slug: <?= e($category['slug']) ?></div>
